...
type Transaction struct {
	...
	Type           TransactionsType   `boil:"type" json:"type" toml:"type" yaml:"type"`
	CardType       string             `boil:"card_type" json:"card_type" toml:"card_type" yaml:"card_type"`
	AmountCaptured uint               `boil:"amount_captured" json:"amount_captured" toml:"amount_captured" yaml:"amount_captured"`
	InvoiceID      uint               `boil:"invoice_id" json:"invoice_id" toml:"invoice_id" yaml:"invoice_id"`
	Status         TransactionsStatus `boil:"status" json:"status" toml:"status" yaml:"status"`
...
var TransactionTableColumns = struct {
	...
	CardType:       "transactions.card_type",
	AmountCaptured: "transactions.amount_captured",
	InvoiceID:      "transactions.invoice_id",
	Status:         "transactions.status",
}

// Generated where

type whereHelperTransactionsType struct{ field string }

func (w whereHelperTransactionsType) EQ(x TransactionsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperTransactionsType) NEQ(x TransactionsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperTransactionsType) LT(x TransactionsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperTransactionsType) LTE(x TransactionsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperTransactionsType) GT(x TransactionsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperTransactionsType) GTE(x TransactionsType) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperTransactionsType) IN(slice []TransactionsType) qm.QueryMod {
...
func (w whereHelperTransactionsType) NIN(slice []TransactionsType) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
type whereHelperTransactionsStatus struct{ field string }

func (w whereHelperTransactionsStatus) EQ(x TransactionsStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperTransactionsStatus) NEQ(x TransactionsStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperTransactionsStatus) LT(x TransactionsStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperTransactionsStatus) LTE(x TransactionsStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperTransactionsStatus) GT(x TransactionsStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperTransactionsStatus) GTE(x TransactionsStatus) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperTransactionsStatus) IN(slice []TransactionsStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
func (w whereHelperTransactionsStatus) NIN(slice []TransactionsStatus) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var TransactionWhere = struct {
	...
	Type           whereHelperTransactionsType
	CardType       whereHelperstring
	AmountCaptured whereHelperuint
	InvoiceID      whereHelperuint
	Status         whereHelperTransactionsStatus
}{
	ID:             whereHelperuint{field: "`transactions`.`id`"},
	UserID:         whereHelperuint{field: "`transactions`.`user_id`"},
	Type:           whereHelperTransactionsType{field: "`transactions`.`type`"},
	CardType:       whereHelperstring{field: "`transactions`.`card_type`"},
	AmountCaptured: whereHelperuint{field: "`transactions`.`amount_captured`"},
	InvoiceID:      whereHelperuint{field: "`transactions`.`invoice_id`"},
	Status:         whereHelperTransactionsStatus{field: "`transactions`.`status`"},
}
...
var (
	transactionAllColumns            = []string{"id", "user_id", "type", "card_type", "amount_captured", "invoice_id", "status"}
	transactionColumnsWithoutDefault = []string{"id", "user_id", "type", "card_type", "amount_captured", "invoice_id", "status"}
	transactionColumnsWithDefault    = []string{}
...
func (o TransactionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM `transactions` WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 0, transactionPrimaryKeyColumns, len(o))
